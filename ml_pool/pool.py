...
class MLPool:
    ...
    def get_scoring_result(
        ...
        """
        Get result of the score_model_func callable ran on the pool using the
        job_id generated by the schedule_model_scoring method.

        If result for the job_id is not available yet and the
